...
@NgModule({
  ...
  exports: [ LoginComponent, EditStoryComponent, AddStoryComponent, AddStoryReactiveComponent ],
  declarations: [ LoginComponent, EditStoryComponent, AddStoryComponent, AddStoryReactiveComponent, FileValueAccessorDirective ],
